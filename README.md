...
Installation: 
The user just download the code and put it in a directory. Then the user can write their own code refereing to the examples provided by "make_periodoframe.R", "MP.R" and "prepare_data.R". The author can also use the functions directly to make BFP and MLP. 
